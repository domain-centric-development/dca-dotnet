...
using DomainCentric.ArchRules.Tests.Fixtures.UseCase.Good.Ordering.Application.PlaceOrder;

namespace DomainCentric.ArchRules.Tests.Fixtures.UseCase.Good.Ordering.Adapter.Incoming.Rest;
